...
RTTS_VOC_ROOT="./data/RTTS"
TEST_LIST="./data/RTTS/test.txt"
NAMES_FILE="./data/voc.names"
WEIGHTS_PATH="./results/YOLOV3_VOC_foggy_mixed/best.pth.tar"
# ==========================================
...
python scripts/voc_RTTS.py --data_path "$RTTS_VOC_ROOT" --test_annotation "$TEST_LIST"
